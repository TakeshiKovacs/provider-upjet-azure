...
// ResolveReferences of this AzureAPIMGroup.
func (mg *AzureAPIMGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this AzureAPIMProductGroup.
func (mg *AzureAPIMProductGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
