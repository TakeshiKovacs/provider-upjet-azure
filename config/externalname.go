...
var TerraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	"azurerm_api_management_group": config.TemplatedStringAsIdentifier("group_name", "/subscriptions/{{ .setup.configuration.subscription_id }}/resourceGroups/{{ .parameters.resource_group_name }}/providers/Microsoft.ApiManagement/service/{{ .parameters.api_management_name }}/groups/{{ .external_name }}"),
